...
export default class UltimateListViewScreen extends Component {
  constructor(props) {
    super(props);
    this.state = {
      layout: 'list',
    ...
    <View>
      <View style={styles.header}>
        <Text style={{textAlign: 'center'}}>
          I am the Header View, you can put some Instructions or Ads Banner
          here!
        </Text>
      </View>
      ...
      <View style={styles.container}>
        <Header searchBar rounded>
          <Item style={{backgroundColor: 'lightgray', borderRadius: 5}}>
            ...
            <Input
              placeholder="Search"
              onChangeText={this.onChangeScrollToIndex}
